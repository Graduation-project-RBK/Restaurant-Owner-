  ...
  <nav className="flex-no-wrap relative flex w-full items-center justify-between bg-[#ffffff] py-2 shadow-md border-black dark:bg-white dark:shadow-gray-900 lg:flex-wrap lg:justify-start lg:py-3">
    <div className="flex w-full flex-wrap items-center justify-between px-3">
      ...
      >
        {/* Logo */}
        <a
          className="mb-4 ml-2 mr-5 mt-3 flex items-center text-red-600 hover:text-neutral-100 focus:text-neutral-100 dark:text-red-500 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0 "
          href="/home"
          style={{ fontSize: '25px' }}
        >
